 ...
 * @param <V>
 */
public class IndexedCollectionDirectory<V> extends IndexedMetaCollection<V> {
    
    private IndexedKeyDirectory<IndexedKey> indexedKeyDirectory;
    private IndexedCollection<IndexedCollection<IndexedKey>> 
     ...
     * @param masterClass
     */
    public IndexedCollectionDirectory (Class<V> masterClass) {
        super(masterClass);
    }
    ...
    public final void buildIndexedKeyDirectory 
        ...
        indexedKeyDirectory 
                = new IndexedKeyDirectory<IndexedKey>(IndexedKey.class);
